...
class DataIngestion:
    ...
    def parse_method(self, string_input):
        ...
        values = re.split(",", re.sub('\r\n', '', re.sub('"', '',
                                                         string_input)))
        row = dict(
            zip(('customer_id', 'Frequency', 'recency', 'T', 'monetary_value'),
                values))
...
def run(argv=None):
    ...
    parser.add_argument(
        ...
        default='gs://gcp-dmo-poc-bucket-raw/IntrendShoes/2-datasets/returning_customers_summary.csv')
    ...
    parser.add_argument('--output',
                        ...
                        default='data_lake_raw.returning_customers_summary1')
    ...
    (p
     ...
     'Write to BigQuery' >> beam.io.Write(
         beam.io.BigQuerySink(
             ...
             # fieldName:fieldType
             schema='customer_id:STRING,Frequency:STRING,recency:STRING,T:STRING,monetary_value:STRING',
